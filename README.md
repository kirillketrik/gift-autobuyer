...
1. Нажмите **📝 Получатели** в главном меню.
2. Нажмите **📝 Редактировать** в появившемся меню.
3. Введите username'ы получателей через запятую (например: `user1,user2,mychannel`). Символ `@` указывать не нужно.
4. После ввода система покажет кликабельные валидные username’ы.
5. Убедитесь, что всё правильно, и нажмите **✅ Подтвердить**.
6. Старые получатели будут заменены на новых.
...
##### 2.2.1. Меню
   ...
   Достаточно нажать на **💎 Фильтры**, чтобы перейти в меню для управления фильтрами.
   В нём находятся следующие кнопки:
...
4. Используйте **⬅️ / ➡️**, чтобы листать сформированные фильтры.
5. Нажмите **✅ Сохранить**, чтобы подтвердить.

##### 2.2.3. Удаление фильтров

1. Нажмите **🗑️ Удалить**.
2. Введите ID фильтров через запятую, например: `1,3,5`.
