...
- Если какое-либо значение не указано, используй значение по умолчанию: `-1`, `0`, `true`, `"–price"`.
...
3. "Сначала бери подарки подешевле" → фильтр с `ordering: "+price"`.
4. "Игнорируй дорогие подарки" → фильтр с `enabled: false` и соответствующими условиями.
